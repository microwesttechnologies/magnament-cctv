    ...
    public function test_dashboard_second_request_reuses_snapshot_cache(): void
    {
        ...
        $miss = $this->countQueries(function (): void {
            $this->get('/dashboard')
                ...
                ->assertDontSee('Órdenes pendientes')
                ->assertDontSee('Órdenes asignadas')
                ->assertDontSee('Órdenes en proceso')
                ->assertDontSee('Órdenes resueltas')
                ->assertDontSee('Órdenes canceladas')
